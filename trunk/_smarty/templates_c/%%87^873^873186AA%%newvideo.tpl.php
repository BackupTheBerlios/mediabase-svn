<?php /* Smarty version 2.6.11, created on 2006-04-15 14:18:33
         compiled from newvideo.tpl */ ?>
 ...
 ?>
        ...
        <div id="content">
            ...
            <div class="inputrow">
                ...
                <input type="text" id="title" name="title" value="<?php echo $this->_tpl_vars['post']['title']; ?>
" />
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="subtitle">Subtitle:</label></p>
                <input type="text" id="subtitle" name="subtitle" value="<?php echo $this->_tpl_vars['post']['subtitle']; ?>
" />
            </div>
            ...
            <div class="inputrow">
                ...
                <input type="text" id="runtime" name="runtime" value="<?php echo $this->_tpl_vars['post']['runtime']; ?>
" /><span class="tip">Eingabe nur in Minuten</span>
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="country">Produktionsland:</label></p>
                <input type="text" id="country" name="country" value="<?php echo $this->_tpl_vars['post']['country']; ?>
" /><span class="tip">USA, Deutschland, Canada, etc.</span>
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="year">Produktionsjahr:</label></p>
                <input type="text" id="year" name="year" value="<?php echo $this->_tpl_vars['post']['year']; ?>
" />
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="director">Regisseur:</label></p>
                <input type="text" id="director" name="director" value="<?php echo $this->_tpl_vars['post']['director']; ?>
" />
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="cast">Schauspieler:</label></p>
                <input type="text" id="cast" name="cast" value="<?php echo $this->_tpl_vars['post']['cast']; ?>
" /><span class="tip">Schauspieler kommagetrennt eingeben</span>
            ...
            <div class="inputrow">
                ...
                <input type="text" id="diskid" name="diskid" value="<?php echo $this->_tpl_vars['post']['diskid']; ?>
" />
            </div>
            ...
            <div class="inputrow">
                ...
                <textarea id="plot" name="plot"><?php echo $this->_tpl_vars['post']['plot']; ?>
</textarea>
            </div>
            ...
            <div class="inputrow">
                ...
                <textarea id="comment" name="comment"><?php echo $this->_tpl_vars['post']['comment']; ?>
</textarea>
            </div>
            <?php endif; ?>
            ...
            <div class="inputrow">
                ...
                <input type="text" id="filename" name="filename" value="<?php echo $this->_tpl_vars['post']['filename']; ?>
" />
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="filesize">Dateigr&ouml;&szlig;e (MB):</label></p>
                <input type="text" id="filesize" name="filesize" value="<?php echo $this->_tpl_vars['post']['filesize']; ?>
" /><span class="tip">Eingabe nur in Megabytes</span>
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="rating">Qualit&auml;t (1..10):</label></p>
                <input type="text" id="rating" name="rating" value="<?php echo $this->_tpl_vars['post']['rating']; ?>
" /><span class="tip">Video- und Soundqualit&auml;t.  10.. beste</span>
            ...
            <div class="inputrow">
                ...
                <input type="text" id="audiocodec" name="audiocodec" value="<?php echo $this->_tpl_vars['post']['audiocodec']; ?>
" /><span class="tip">z.B. AC3, AAC, usw.</span>
            </div>
            
            <div class="inputrow">
                <p class="label"><label for="videocodec">Videocodec:</label></p>
                <input type="text" id="videocodec" name="videocodec" value="<?php echo $this->_tpl_vars['post']['videocodec']; ?>
